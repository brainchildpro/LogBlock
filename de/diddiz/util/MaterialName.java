                        ...
                        if (isByte(data)) {
                            if (sec.isString(data))
                                dataNames.put(Byte.valueOf(data), sec.getString(data));
                                    ...
                                    "Parsing materials.yml: '" + data + "' is not a string.");
                        } else getLogger().warning(
                                "Parsing materials.yml: '" + data + "' is no valid material data");
                } else getLogger().warning(
                        "Parsing materials.yml: '" + entry + "' is neither a string nor a section.");
